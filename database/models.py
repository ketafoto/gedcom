...
class Individual(Base):
    ...
    birth_date_gedcom = Column(String, nullable=True)  # Raw GEDCOM date string for non-exact dates, e.g. 'ABT 1970'
    birth_place = Column(String, nullable=True)
    death_date = Column(Date, nullable=True)
    death_date_gedcom = Column(String, nullable=True)  # Raw GEDCOM date string for non-exact dates, e.g. 'ABT 1970'
...
class Family(Base):
    ...
    marriage_date_gedcom = Column(String, nullable=True)  # Raw GEDCOM date string for non-exact dates, e.g. 'ABT 1970'
    marriage_place = Column(String, nullable=True)
    divorce_date = Column(Date, nullable=True)
    divorce_date_gedcom = Column(String, nullable=True)  # Raw GEDCOM date string for non-exact dates, e.g. 'ABT 1970'
...
class Event(Base):
    ...
    event_date_gedcom = Column(String, nullable=True)  # Raw GEDCOM date string for non-exact dates, e.g. 'ABT 1970'
...
class Media(Base):
    ...
    media_date_gedcom = Column(String, nullable=True)  # Raw GEDCOM date string for non-exact dates, e.g. 'ABT 1970'
    description = Column(Text, nullable=True)
