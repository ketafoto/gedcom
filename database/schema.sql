...
CREATE TABLE IF NOT EXISTS main_individuals (
  ...
  birth_date TEXT,
  birth_date_gedcom TEXT,   -- Raw GEDCOM date string for non-exact dates, e.g. 'ABT 1970'
  birth_place TEXT,
  death_date TEXT,
  death_date_gedcom TEXT,   -- Raw GEDCOM date string for non-exact dates, e.g. 'ABT 1970'
  death_place TEXT,
  notes TEXT
);
...
CREATE TABLE IF NOT EXISTS main_families (
  ...
  gedcom_id TEXT UNIQUE,
  marriage_date TEXT,
  marriage_date_gedcom TEXT,  -- Raw GEDCOM date string for non-exact dates, e.g. 'ABT 1970'
  marriage_place TEXT,
  divorce_date TEXT,
  divorce_date_gedcom TEXT,   -- Raw GEDCOM date string for non-exact dates, e.g. 'ABT 1970'
...
CREATE TABLE IF NOT EXISTS main_events (
  ...
  event_date TEXT,
  event_date_gedcom TEXT,     -- Raw GEDCOM date string for non-exact dates, e.g. 'ABT 1970'
  event_place TEXT,
  description TEXT
);
...
CREATE TABLE IF NOT EXISTS main_media (
  ...
  media_date TEXT,
  media_date_gedcom TEXT,     -- Raw GEDCOM date string for non-exact dates, e.g. 'ABT 1970'
  description TEXT
);
