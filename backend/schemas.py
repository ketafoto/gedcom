...
class IndividualBase(BaseModel):
    ...
    birth_date_gedcom: Optional[str] = None  # Raw GEDCOM date string for non-exact dates, e.g. 'ABT 1970'
    birth_place: Optional[str] = None
    death_date: Optional[date] = None
    death_date_gedcom: Optional[str] = None  # Raw GEDCOM date string for non-exact dates, e.g. 'ABT 1970'
...
class FamilyBase(BaseModel):
    ...
    marriage_date_gedcom: Optional[str] = None  # Raw GEDCOM date string for non-exact dates, e.g. 'ABT 1970'
    marriage_place: Optional[str] = None
    divorce_date: Optional[date] = None
    divorce_date_gedcom: Optional[str] = None  # Raw GEDCOM date string for non-exact dates, e.g. 'ABT 1970'
...
class EventBase(BaseModel):
    ...
    event_date_gedcom: Optional[str] = None  # Raw GEDCOM date string for non-exact dates, e.g. 'ABT 1970'
...
class MediaBase(BaseModel):
    ...
    media_date_gedcom: Optional[str] = None  # Raw GEDCOM date string for non-exact dates, e.g. 'ABT 1970'
    description: Optional[str] = None
